...
const SingleProductCategory = ({ product }) => {
  ...
  return (
    <div className="productCategory mx-auto shadow  rounded  hover:bg-gray-100">
      <Link
      ...
      >
        ...
        />
        {/* hover button */}
        <div className="absolute top-1/3 SH-button-position  xl:invisible group-hover:visible">
          <object className="flex items-center  bg-gray-300 p-1 md:p-3">
            <Link
              onClick={() => handleAddToCart(_id)}
              className=" text-xs md:text-lg px-1 md:px-2"
            >
              <svg
                fill="#000000"
                width="25px"
        ...
        {/* Card Content */}
        <div className="">
          <p className="truncate font-bold px-2 md:px-4">{slicedText}</p>
