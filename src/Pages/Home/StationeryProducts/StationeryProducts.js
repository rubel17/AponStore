...
import pure from "../../../assets/image/deli-correction-pen-cover-up-pink-7-ml-1-pcs.webp";
import { Link } from "react-router-dom";

const StationeryProducts = ({ text = "Deli Correction Pen" }) => {
    ...
    <div className="mt-20">
      ...
      <div className="xl:flex">
        <div className=" xl:w-1/3 xl:ml-3 mt-8">
          <img className="w-full px-4 xl:px-0" src={StationeryProduct} alt="" />
        </div>
