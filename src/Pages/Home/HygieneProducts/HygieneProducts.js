...
import pure from "../../../assets/image/aci-savlon-liquid-antiseptic-1000-ml.webp";
import { Link } from "react-router-dom";

const HygieneProducts = ({ text = "ACI Savlon Liquid" }) => {
    ...
    <div className="mt-20">
      ...
      <div className="xl:flex">
        <div className=" xl:w-1/3 xl:ml-3 mt-8">
          <img className="w-full px-4 xl:px-0" src={hygieneProduct} alt="" />
        </div>
