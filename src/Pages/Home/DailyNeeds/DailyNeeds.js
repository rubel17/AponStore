...
import pure from "../../../assets/image/chashi-aromatic-chinigura-rice-1-kg.webp";
import { Link } from "react-router-dom";

const DailyNeeds = ({ text = "Chashi Aromatic" }) => {
    ...
    <div className="mt-20">
      ...
      <div className="xl:flex">
        <div className=" xl:w-1/3 xl:ml-3 mt-8">
          <img className="w-full px-4 xl:px-0" src={dailyNeeds} alt="" />
        </div>
